 ...
 * @author 19688016-K
 */
public class Controlador_buscar_producto {
    ...
    public void Eliminar(String respuesta) {
        try {
            int cod = Integer.parseInt(respuesta);
            DAO_Inventario u = new DAO_Inventario();
            if (u.find(cod) != true) {
                ...
                JOptionPane.showMessageDialog(null, "Codigo incorrecto", "Error #04", JOptionPane.WARNING_MESSAGE);
            }
        } catch (HeadlessException | NumberFormatException e) {
            JOptionPane.showMessageDialog(null, "ingrese solo numeros", "Error #04", JOptionPane.WARNING_MESSAGE);
        }
